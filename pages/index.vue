...
.index-page
  ...
  .hero
    .hero__text
      BaseText(tag="h1").text-35px.text-md-70px Hi, I'm Axel Rizo
      BaseText(tag="h2").text-15px.text-md-25px Self-taught frontend developer
    .hero__picture
  ...
  BaseContainer.contact
    ...
    form.contact__form.contact-form(
